export default function Keyboard() {
  ...
  <section>
    ...
    <p>
      That made life a lot easier. The module handled RF and charging circuitry internally, leaving me to focus on:
    </p>
    <ul>
    ...
    <figure>
      <img src="images/easyeda-pcb-view.jpg" alt="EasyEDA PCB view of the Charybdis redesign">
      <figcaption>PCB layout in EasyEDA showing the SuperMini nRF52840 and RGB LED routing.</figcaption>
    </figure>
  </section>
  ...
  <section>
    ...
    <p>
      ...
      and logic level mismatches, since the LEDs expect 5&nbsp;V but the keyboard runs from a 3.3&nbsp;V Li-ion setup.
    </p>
    <ul>
      <li>Used a logic-level shifter to translate the 3.3&nbsp;V data signal reliably</li>
    ...
    <figure>
      <img src="images/rgb-keyboard-lit.jpg" alt="Per-key RGB lighting on the custom wireless Charybdis">
      <figcaption>Per-key RGB lighting powered by SK6812 Mini-E LEDs, driven at 3.3&nbsp;V logic.</figcaption>
    </figure>
  </section>
  ...
  <section>
    ...
    <p>
      Once it paired over BLE and typed its first sentence, the project officially crossed from idea to reality.
    </p>

    <figure>
      <img src="images/zmk-config.jpg" alt="ZMK firmware configuration screenshot">
      <figcaption>Custom ZMK configuration and keymap setup for the nRF52840 board.</figcaption>
    </figure>
  </section>
  ...
  <section>
    ...
    <p>
      Because my board runs at 3.3&nbsp;V, not 5&nbsp;V like the original wired Charybdis, the existing BastardKB sensor setup wasn’t directly compatible. 
      I sourced a different optical sensor that supported 3.3&nbsp;V operation, redesigned the PCB again to simplify the circuitry — and then hit the real challenge: 
  ...
  <section>
    ...
    <p>
      The sensor communicated over SPI, but the datasheet was vague and ZMK didn’t have built-in support. 
      I ended up implementing the driver from scratch:
    </p>
    <ul>
    ...
    <p>
      It was a crash course in embedded device integration — balancing timing, protocol reliability, and clean data flow into ZMK’s pointer input system. 
      Even though the sensor may have been faulty, the experience of writing and testing my own firmware driver was incredibly rewarding.
    </p>

    <figure>
      <img src="images/trackball-pcb.jpg" alt="Custom trackball PCB and sensor module">
      <figcaption>Trackball PCB iteration featuring the 3.3&nbsp;V-compatible sensor and SPI interface.</figcaption>
    </figure>
  </section>
  ...
  <section>
    ...
    <p>
      Even without it, the project achieved its core goals:
    </p>
    <ul>
  ...
  <section>
    ...
    <p>
      For me, this project sits right at the intersection of <strong>engineering, design, and interactivity</strong> — the same intersection that defines great game programming. 
  ...
  <section>
    <h2>Gallery</h2>
    <figure>
      <img src="images/final-keyboard.jpg" alt="Finished wireless RGB Charybdis keyboard">
      <figcaption>The finished wireless, per-key RGB Charybdis — functional, bright, and entirely untethered.</figcaption>
    </figure>
    <figure>
      <img src="images/debugging-session.jpg" alt="Firmware debugging output">
      <figcaption>Firmware debugging session during custom SPI driver development.</figcaption>
    </figure>
  </section>
